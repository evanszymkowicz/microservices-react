...
//	requires a local .tfstate file
const tfFilePath = rel("../terraform/terraform.tfstate");

//	will run this if you haven't run terraform apply from the cli
...
const codeDeployClient = new AWS.CodeDeploy({accessKeyId: accessEnv("AWS_ACCESS_KEY_ID"), apiVersion: "2014-10-06", region: awsRegion, secretAccessKey: accessEnv("AWS_ACCESS_KEY_SECRET")});
